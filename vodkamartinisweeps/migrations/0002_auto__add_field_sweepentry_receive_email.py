...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SweepEntry.receive_email'
        db.add_column('vodkamartinisweeps_sweepentry', 'receive_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SweepEntry.receive_email'
        db.delete_column('vodkamartinisweeps_sweepentry', 'receive_email')
